...
from . import views
from .views import HomeView, CursoView, AlunoView, CursoCreateView, EntregaAtividadeView,\
create, delete,cursos, my_logout, boletim, cria_entrega_atividade, edita_entrega_atividade, MensagemViews
