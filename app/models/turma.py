...
class Turma(models.Model):
    ...
    disciplina = models.ManyToManyField(Disciplina, related_name='disciplinas_turma')
    curso = models.ForeignKey(Curso, on_delete=models.PROTECT, related_name='cursos_turmas')
